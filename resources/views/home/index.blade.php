...
<body>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="border-end border-primary pe-3">
                            <a href="#" class="text-muted small"><i
                                    class="fas fa-map-marker-alt text-primary me-2"></i>Yogyakarta, Indonesia</a>
                        </div>
                        <div class="ps-3">
                            <a href="mailto:example@gmail.com" class="text-muted small"><i
                                    class="fas fa-envelope text-primary me-2"></i>development.vastech@gmail.com</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a href="#" class="navbar-brand p-0">
                    <h1 class="text-primary mb-0"><i class="fab fa-slack me-2"></i> Vastech</h1>
                    <!-- <img src="{{ asset('assets/img/vastech.svg') }}" style="width: 50px; height: 40px;" alt="Logo"> -->
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-0 mx-lg-auto">
                        ...
                        <div class="nav-btn px-3">
                            <button
                                class="btn-search btn btn-outline-primary btn-md-square rounded-circle flex-shrink-0"
                ...
                <div class="d-none d-xl-flex flex-shrink-0 ps-4">
                    ...
                    <div class="d-flex flex-column ms-3">
                        ...
                        <a href="https://wa.me/6282328513304" whatsapp-link target="_blank"><span class="text-dark">082
                                328 513 304</span></a>
                    </div>
                </div>
            </nav>
    ...
    {{-- style="background-image: url('{{ asset('assets/img/pc-4.jpg') }}');
                ...
                <div class="container">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7 animated fadeInLeft">
                            <div class="text-sm-center text-white text-md-start">
                                <h4 class="text-uppercase text-white fw-bold mb-4">Welcome To</h4>
                                <h1 class="display-1 mb-4 text-white">Vastu Cipta Teknologi </h1>
                                <p class="mb-5 fs-5">Menyediakan jasa pembuatan website profesional untuk segala jenis
                                    bidang usaha yang ingin menyebarkan informasi di
                                    internet agar lebih cepat dan efisien.
                                </p>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-5">
                                <div class="footer-item">
                                    <a href="index.html" class="p-0">
                                        <h3 class="text-white"><i class="fab fa-slack me-3"></i> Vastech</h3>
                                        <!-- <img src="img/logo.png" alt="Logo"> -->
                                    </a>
                                    <p class="text-white mb-4">enyediakan jasa pembuatan website profesional untuk
                                        segala jenis
                                        bidang usaha yang ingin menyebarkan informasi di
                                        internet agar lebih cepat dan efisien</p>
                ...
                <div class="col-md-7 text-center text-md-end mb-md-0">
                    <span class="text-body">
                        <a href="#" class="border-bottom">
                            <i class="fa fa-copyright"></i>Vastech
                        </a>,
                        All rightreserved.</span>
                </div>
            </div>
        </div>
    </div>
